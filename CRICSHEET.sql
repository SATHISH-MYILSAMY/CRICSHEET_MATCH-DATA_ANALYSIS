...
CREATE TABLE IF NOT EXISTS CRICSHEET.IPL_MATCHES (
...
CREATE TABLE IF NOT EXISTS CRICSHEET.T20_MATCHES (
    meta_data_version VARCHAR(255),
    meta_created DATETIME,
    meta_revision VARCHAR(255),
    info_city VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS CRICSHEET.ODI_MATCHES (
    meta_data_version VARCHAR(255),
    meta_created DATETIME,
    meta_revision VARCHAR(255),
    info_city VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS CRICSHEET.TEST_MATCHES (
    meta_data_version VARCHAR(255),
    meta_created DATETIME,
    meta_revision VARCHAR(255),
    info_city VARCHAR(255),
...
DESC CRICSHEET.IPL_MATCHES;

DESC CRICSHEET.ODI_MATCHES;

DESC CRICSHEET.T20_MATCHES;

DESC CRICSHEET.TEST_MATCHES;

SELECT * FROM CRICSHEET.IPL_MATCHES;

SELECT * FROM CRICSHEET.ODI_MATCHES;

SELECT * FROM CRICSHEET.T20_MATCHES;

SELECT * FROM CRICSHEET.TEST_MATCHES;

ALTER TABLE CRICSHEET.IPL_MATCHES MODIFY innings_target INT NULL;
ALTER TABLE CRICSHEET.ODI_MATCHES MODIFY innings_target INT NULL;
ALTER TABLE CRICSHEET.T20_MATCHES MODIFY innings_target INT NULL;

ALTER TABLE CRICSHEET.IPL_MATCHES MODIFY COLUMN info_season VARCHAR(255);
ALTER TABLE CRICSHEET.ODI_MATCHES MODIFY COLUMN info_season VARCHAR(255);
ALTER TABLE CRICSHEET.T20_MATCHES MODIFY COLUMN info_season VARCHAR(255);
ALTER TABLE CRICSHEET.TEST_MATCHES MODIFY COLUMN info_season VARCHAR(255);
...
SELECT info_outcome_winner, 
       (COUNT(info_outcome_winner) / (SELECT COUNT(*) FROM CRICSHEET.IPL_MATCHES)) * 100 AS win_percentage
FROM CRICSHEET.IPL_MATCHES
